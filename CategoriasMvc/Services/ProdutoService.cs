...
public class ProdutoService : IProdutoService
{
    ...
    public async Task<IEnumerable<ProdutoViewModel>> GetProdutos(string token)
    {
        ...
        PuTokenInHeaderAuthorization(token, client);
    ...
    public async Task<ProdutoViewModel> CriaProdutos(ProdutoViewModel ProdutosVM, string token)
    {
        var client = _clientFactory.CreateClient("produtosApi");
        PuTokenInHeaderAuthorization(token, client);
    ...
    public async Task<bool> AtualizaProdutos(int id, ProdutoViewModel ProdutosVM, string token)
    {
        var client = _clientFactory.CreateClient("ProdutosApi");
        PuTokenInHeaderAuthorization(token, client);
    ...
    public async Task<bool> DeletaProdutos(int id, string token)
    {
        var client = _clientFactory.CreateClient("ProdutosApi");
    ...
    private static void PuTokenInHeaderAuthorization(string token, HttpClient client)
    {
